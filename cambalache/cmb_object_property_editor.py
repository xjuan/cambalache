#
# CmbObjectPropertyEditor - Cambalache Object Editor
#
...
class CmbObjectPropertyEditor(Gtk.Box):
    __gtype_name__ = "CmbObjectPropertyEditor"
...
Gtk.WidgetClass.set_css_name(CmbObjectPropertyEditor, "CmbObjectPropertyEditor")
